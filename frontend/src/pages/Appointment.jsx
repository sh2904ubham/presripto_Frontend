    ...
    for (let i = 0; i < 7; i++) {
      ...
      if (today.getDate() === currentDate.getDate()) {
        ...
        currentDate.setMinutes(
          currentDate.getMinutes() > 30 ? currentDate.getMinutes() + 30 : 0
        );
      } else {
  ...
  return (
    docInfo && (
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            <div className="flex items-center gap-4 mt-1 text-sm">
              ...
              <button className="px-4 py-0.5 border text-xs rounded-full">
                {docInfo.experience}
              </button>
            </div>
        ...
        {/* booking slots */}
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-zinc-700">
          <p>Booking slots</p>
          <div className="flex gap-3 items-center w-full over-flow-x-scrroll mt-4">
            {docSlots.length &&
